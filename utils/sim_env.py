...
def make_sim_env(task_name: str) -> control.Environment:
    """
...
class BimanualViperXTask(base.Task):
    ...
    def initialize_episode(self, physics: mujoco.Physics) -> None:
        """Sets the state of the environment at the start of each episode."""
        super().initialize_episode(physics)

    @staticmethod
    def get_qpos(physics: mujoco.Physics) -> np.ndarray:
    ...
    @staticmethod
    def get_qvel(physics: mujoco.Physics) -> np.ndarray:
    ...
    @staticmethod
    def get_env_state(physics: mujoco.Physics) -> np.ndarray:
        raise NotImplementedError

    def get_observation(self, physics: mujoco.Physics) -> collections.OrderedDict:
...
def get_action(master_bot_left, master_bot_right) -> np.ndarray:  # noqa: ANN001
    action = np.zeros(14)
    # arm action

...
from utils.constants import SIM_TASK_CONFIGS
from utils.ee_sim_env import make_ee_sim_env
...
class BasePolicy:
    ...
    def generate_trajectory(self, ts_first: None) -> None:
        raise NotImplementedError

    @staticmethod
    def interpolate(curr_waypoint: None, next_waypoint: None, t: None) -> None:
...
class InsertionPolicy(BasePolicy):
    ...
    def generate_trajectory(self, ts_first: None) -> None:
        ...
        self.left_trajectory = [
            ...
            {"t": 0, "xyz": init_mocap_pose_left[:3], "quat": init_mocap_pose_left[3:], "gripper": 0},
            # approach the cube
            {"t": 120, "xyz": socket_xyz + np.array([0, 0, 0.08]), "quat": gripper_pick_quat_left.elements, "gripper": 1},  # noqa: E501
            # go down
            {"t": 170, "xyz": socket_xyz + np.array([0, 0, -0.03]), "quat": gripper_pick_quat_left.elements, "gripper": 1},  # noqa: E501
            # close gripper
            {"t": 220, "xyz": socket_xyz + np.array([0, 0, -0.03]), "quat": gripper_pick_quat_left.elements, "gripper": 0},  # noqa: E501
            # approach meet position
            {"t": 285, "xyz": meet_xyz + np.array([-0.1, 0, 0]), "quat": gripper_pick_quat_left.elements, "gripper": 0},
            # insertion
            {"t": 340, "xyz": meet_xyz + np.array([-0.05, 0, 0]), "quat": gripper_pick_quat_left.elements, "gripper": 0},  # noqa: E501
            # insertion
            {"t": 400, "xyz": meet_xyz + np.array([-0.05, 0, 0]), "quat": gripper_pick_quat_left.elements, "gripper": 0},  # noqa: E501
        ]
        ...
        self.right_trajectory = [
            ...
            # go down
            {"t": 170, "xyz": peg_xyz + np.array([0, 0, -0.03]), "quat": gripper_pick_quat_right.elements, "gripper": 1},  # noqa: E501
            # close gripper
            {"t": 220, "xyz": peg_xyz + np.array([0, 0, -0.03]), "quat": gripper_pick_quat_right.elements, "gripper": 0},  # noqa: E501
            # approach meet position
            {"t": 285, "xyz": meet_xyz + np.array([0.1, 0, lift_right]), "quat": gripper_pick_quat_right.elements, "gripper": 0},  # noqa: E501
            # insertion
            {"t": 340, "xyz": meet_xyz + np.array([0.05, 0, lift_right]), "quat": gripper_pick_quat_right.elements, "gripper": 0},  # noqa: E501
            # insertion
            {"t": 400, "xyz": meet_xyz + np.array([0.05, 0, lift_right]), "quat": gripper_pick_quat_right.elements, "gripper": 0},  # noqa: E501
        ]


def test_policy(task_name: None) -> None:
